...
public static class StringExtensions
{
    ...
    */
    ...
    {
#if (UNITY_WP8) || (UNITY_WP8) || (UNITY_METRO) || (UNITY_WINRT)
        return mText;
#else
    ...
    /// <summary>
    /// Finds the specified Start Content and the End Content in this string _instance, and returns a string
    ...
    /// <param name="startText">The Start Content to begin the Subset from.</param>
    /// <param name="endText">The End Content to where the Subset goes to.</param>
    ...
    public static string SubsetString(this string s, string startText, string endText, bool ignoreCase)
    {
        ...
        if (startText.IsNullOrEmpty() || endText.IsNullOrEmpty())
            throw new ArgumentException("Start Content and End Content cannot be empty.");
