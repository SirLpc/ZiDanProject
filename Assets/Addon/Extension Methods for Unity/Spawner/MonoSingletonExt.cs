...
public abstract class MonoSingletonExt<T> : MonoBehaviour where T : MonoSingletonExt<T>
{
    ...
    private const string STR_NoInstanceOfATemporaryOneIsCreated = "No _instance of {0}, a temporary one is created.";
    ...
    // If no other monobehaviour request the _instance in an awake function
    ...
    // This function is called when the _instance is used the first time
    // Put all the initializations you need here, as you would do in Awake
    public virtual void Init() { }

    // Make sure the _instance isn't referenced anymore when the user quit, just in case.
