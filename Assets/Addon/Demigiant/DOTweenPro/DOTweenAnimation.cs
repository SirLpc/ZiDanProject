...
//                if (c != null) {
//                    tween = ((Content)c).DOColor(endValueColor, duration);
//                    goto SetupTween;
//                }
                break;
...
//                c = this.GetComponent<Content>();
//                if (c != null) {
//                    tween = ((Content)c).DOFade(endValueFloat, duration);
//                    goto SetupTween;
//                }
                break;
...
//                c = this.GetComponent<Content>();
//                if (c != null) {
//                    tween = ((Content)c).DOText(endValueString, duration, optionalBool0, optionalScrambleMode, optionalString);
//                    goto SetupTween;
//                }
#if DOTWEEN_TK2D
